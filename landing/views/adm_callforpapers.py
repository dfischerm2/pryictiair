...
from landing.forms import CallForPapersForm
...
@login_required
# @secure_module
def callPaperView(request):
    data = {'titulo': 'Call for Papers',
            'modulo': 'Papers',
            'ruta': request.path,
    ...
    if request.method == 'POST':
        ...
        return render(request, 'conference/callpaper/listado.html', data)
