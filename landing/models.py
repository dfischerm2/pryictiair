...
class Conference(ModeloBase):
    ...
    base_papers = models.IntegerField(default=0, verbose_name='Cantidad base de Papers')
    base_sheets = models.IntegerField(default=0, verbose_name='Cantidad base de Hojas por paper')
    max_papers = models.IntegerField(default=0, verbose_name='Cantidad máxima de Papers adicionales')
