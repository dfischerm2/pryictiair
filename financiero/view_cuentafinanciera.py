        ...
        try:
            with transaction.atomic():
                if action == 'add':
                    ...
                    if form.is_valid():
                        form.save()
                        log(f"Agrego cuenta financiera {form.instance.__str__()}", request, "add",obj=form.instance.id)
                    ...
                    if form.is_valid() and filtro:
                        form.save()
                        log(f"Edito cuenta financiera {form.instance.__str__()}", request, "change",obj=form.instance.id)
                    ...
                    filtro.status = False
                    filtro.save(request)
                    log(f"Elimino cuenta financiera {filtro.__str__()}", request, "delete",obj=filtro.id)
